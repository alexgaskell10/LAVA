## bash resources/cmds/num_perturbs.sh 
...
victim_dir=resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/
outdir_attacker_base=resources/runs/num_perturbs/
...
base_dir=resources/runs/num_perturbs
...
do
    ...
    do
        ...
        outdir_config=resources/config/num_perturbs/$dt
        mkdir -p $outdir_attacker
        mkdir -p $outdir_config

        # Eval trained attacker on the test set
        raw_config_2=resources/config/num_perturbs/test_config.jsonnet
        proc_config_2=resources/config/num_perturbs/$dt/$ext.jsonnet
...
# data_dir=data/rule-reasoning-dataset-V2020.2.4/depth-5/
# victim_dir=resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/
# outdir_attacker_base=resources/runs/num_perturbs/$dt/
# mkdir -p $outdir_attacker_base
...
#         raw_config_1=resources/config/num_perturbs/config.jsonnet
