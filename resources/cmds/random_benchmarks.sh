...
victim='resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/'
data='data/rule-reasoning-dataset-V2020.2.4/depth-5/test.jsonl'
outdir='resources/runs/baselines/random_adversarial/'
# outpath=$outdir/
...
do
    ...
    raw_config_1=resources/config/baselines/adversarial_benchmark/config.jsonnet
    proc_config_1=resources/config/baselines/adversarial_benchmark/config_$ext.jsonnet
