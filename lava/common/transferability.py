...
from lava.dataset_readers.records_reader import RecordsReader as DataReader
from lava.train.utils import read_pkl

cuda_device = 8
path = 'resources/runs/adversarial/2021-12-03_08-15-20-keep/val-records_epoch2.pkl'
...
config = {
    ...
    "dset_config": {
        ...
        # 'shortest_proof': 1,
        # 'longest_proof': 100,
        # 'pretrained_retriever_model': None, #'resources/runs/pretrain_retriever/rb-base/model.tar.gz',
    ...
    "trainer_config": {
        ...
        'grad_norm': None,
        'cuda_device': cuda_device,
        'serialization_dir': 'resources/runs/pretrained_retriever_ruletaker/roberta/tmp',
        'num_epochs': 4,
...
if __name__ == '__main__':
    ...
    trainer = Trainer(
        ...
        data_loader=dataloader,         # Can do this here as we are not training
        optimizer=optimizer,
