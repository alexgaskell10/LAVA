...
# from lava.models.transformer_binary_qa_model import TransformerBinaryQA as Model
...
config = {
    ...
    "trainer_config": {
        ...
        'grad_norm': None,
        'cuda_device': 2,
        'serialization_dir': 'resources/runs/pretrained_retriever_ruletaker/roberta/tmp1',
        'num_epochs': 4,
