...
paths = {
    ...
    'v_drb-b': 'resources/runs/ruletaker/2021-12-22_09-38-17_distilroberta-base/test_results.json',
    'v_rb-lg:a_rb-b': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    'v_rb-b:a_rb-b': 'resources/runs/adversarial/2021-12-12_19-08-47_roberta-base/test_results-records.pkl',
    'v_drb-b:a_rb-b': 'resources/runs/adversarial/2021-12-22_09-38-17_distilroberta-base/test_results-records.pkl',
    # Baselines
    'v_rb-lg:a_hotflip': 'resources/runs/baselines/hotflip/2021-12-16_11-00-14_reevaled.pkl',
    'v_rb-lg:a_textfooler': 'resources/runs/baselines/textfooler/2021-12-16_11-00-14_reevaled.pkl',
    # Random benchmarks
    'v_rb-lg:a_random': 'resources/runs/baselines/random_adversarial/random_2021-12-22_14-02-58_results-records.pkl',
    'v_rb-lg:a_wordscore': 'resources/runs/baselines/random_adversarial/word_score_2021-12-22_14-02-58_results-records.pkl',
    # Adversarial retraining
    'v_rb-lg_retrain_orig': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large_retrain/test-orig-records_epoch100.pkl',
    'v_rb-lg_retrain_adv': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large_retrain/test-adv-records_epoch100.pkl',
    # Transferability
    'trans-v_rb-lg:v_rb-b': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/transferability_results_2021-12-12_17-38-38_roberta-large--2021-12-12_19-08-47_roberta-base-2-records.pkl',
    'trans-v_rb-b:v_rb-lg': 'resources/runs/ruletaker/2021-12-12_19-08-47_roberta-base/transferability_results_2021-12-12_19-08-47_roberta-base--2021-12-12_17-38-38_roberta-large-2-records.pkl',
    'trans-v_rb-lg:v_rb-lg': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/transferability_results_2021-12-12_17-38-38_roberta-large--2021-12-27_10-16-17_roberta-large-2-records.pkl',
    'trans-v_rb-lg:v_drb-b': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/transferability_results_2021-12-12_17-38-38_roberta-large--2021-12-22_09-38-17_distilroberta-base-2-records.pkl',
    'trans-v_drb-b:v_rb-lg': 'resources/runs/ruletaker/2021-12-22_09-38-17_distilroberta-base//transferability_results_2021-12-22_09-38-17_distilroberta-base--2021-12-12_17-38-38_roberta-large-2-records.pkl',
    'trans-hotflip-v_rb-lg:v_rb-b': 'resources/runs/baselines/hotflip/transferability_results_2021-12-21_18-12-03-records.pkl',
    'trans-textfooler-v_rb-lg:v_rb-b': 'resources/runs/baselines/textfooler/transferability_results_2021-12-21_18-12-03-records.pkl',
    # Adv retraining
    'retrain-v_rb-lg:adv_before': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    'retrain-v_rb-lg:adv_after': 'resources/runs/ruletaker/2021-12-20_10-48-09_roberta-large_retrain_v1/test-adv-records_epoch100.pkl',
    'retrain-v_rb-lg:orig_before': 'resources/runs/ruletaker/2021-12-20_10-48-09_roberta-large/test_results.json',
    'retrain-v_rb-lg:orig_after': 'resources/runs/ruletaker/2021-12-20_10-48-09_roberta-large_retrain_v1/test-orig-records_epoch100.pkl',
    'retrain-v_rb-b:adv_before': 'resources/runs/adversarial/2021-12-12_19-08-47_roberta-base/test_results-records.pkl',
    'retrain-v_rb-b:adv_after': 'resources/runs/ruletaker/2021-12-21_08-55-58_roberta-base_retrain_v1/test-adv-records_epoch100.pkl',
    'retrain-v_rb-b:orig_before': 'resources/runs/ruletaker/2021-12-21_08-55-58_roberta-base/test_results.json',
    'retrain-v_rb-b:orig_after': 'resources/runs/ruletaker/2021-12-21_08-55-58_roberta-base_retrain_v1/test-orig-records_epoch100.pkl',
    'retrain-v_drb-b:adv_before': 'resources/runs/adversarial/2021-12-22_09-38-17_distilroberta-base/test_results-records.pkl',
    'retrain-v_drb-b:adv_after': 'resources/runs/ruletaker/2021-12-22_09-38-17_distilroberta-base_retrain/test-adv-records_epoch100.pkl',
    'retrain-v_drb-b:orig_before': 'resources/runs/ruletaker/2021-12-22_09-38-17_distilroberta-base/test_results.json',
    'retrain-v_drb-b:orig_after': 'resources/runs/ruletaker/2021-12-22_09-38-17_distilroberta-base_retrain/test-orig-records_epoch100.pkl',
    # Analysis
    'v_rb-lg:a_rb-b:ana': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    # Ablations
    # 'all3': 'resources/runs/ablate/2021-12-22_22-34-49/equivalence_substitution,question_flip,sentence_elimination/test_results-records.pkl',
    # '-qf': 'resources/runs/ablate/2021-12-22_22-37-52/sentence_elimination,equivalence_substitution/test_results-records.pkl',
    # '-se': 'resources/runs/ablate/2021-12-22_22-37-52/equivalence_substitution,question_flip/test_results-records.pkl',
    # '-es': 'resources/runs/ablate/2021-12-22_22-37-52/sentence_elimination,question_flip/test_results-records.pkl',
    '-qf': 'resources/runs/ablate/2022-01-06_10-36-21/sentence_elimination,equivalence_substitution/test_results-records.pkl',
    '-se': 'resources/runs/ablate/2022-01-06_10-33-08/equivalence_substitution,question_flip/test_results-records.pkl',
    '-es': 'resources/runs/ablate/2022-01-06_10-35-27/sentence_elimination,question_flip/test_results-records.pkl',
    # Successful sample
    'main_model': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
}

dirs = {
    'num_perturbs': [
        'resources/runs/num_perturbs/2021-12-16_10-41-53',
        'resources/runs/num_perturbs/2021-12-16_10-42-44',
        'resources/runs/num_perturbs/2021-12-16_10-43-16',
        'resources/runs/num_perturbs/2021-12-16_10-43-27',
        'resources/runs/num_perturbs/2021-12-16_10-43-41',
    ],
    'val_mc': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large'
}
...
ref_paths = {
    ...
    # 'v_rb-lg:a_hotflip': 'resources/runs/baselines/textfooler/CustomTextFoolerAttacker_CustomVictim_CustomTokenizer_2021-12-06_22-18-05.pkl',
    # 'v_rb-lg:a_textfooler': 'resources/runs/baselines/textfooler/CustomTextFoolerAttacker_CustomVictim_CustomTokenizer_2021-12-06_22-18-05_reevaled.pkl',
    ...
    'trans-v_rb-lg:v_rb-b': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    'trans-v_rb-b:v_rb-lg': 'resources/runs/adversarial/2021-12-12_19-08-47_roberta-base/test_results-records.pkl',
    'trans-v_rb-lg:v_rb-lg': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    'trans-v_rb-lg:v_drb-b': 'resources/runs/adversarial/2021-12-12_17-38-38_roberta-large/test_results-records.pkl',
    'trans-v_drb-b:v_rb-lg': 'resources/runs/adversarial/2021-12-22_09-38-17_distilroberta-base/test_results-records.pkl',
    'trans-hotflip-v_rb-lg:v_rb-b': 'resources/runs/baselines/hotflip/2021-12-16_11-00-14_reevaled_bu.pkl',
    'trans-textfooler-v_rb-lg:v_rb-b': 'resources/runs/baselines/textfooler/2021-12-16_11-00-14_reevaled_bu.pkl',
    'v_rb-lg:a_rb-b:ana': 'resources/runs/ruletaker/2021-12-12_17-38-38_roberta-large/test_results.json',
    'main_model': 'resources/runs/ruletaker/2021-12-20_10-48-09_roberta-large/test_results.json',
}
