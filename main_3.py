...
def main(prog: Optional[str] = None) -> None:
    ...
    if len(sys.argv) == 1:
        ...
        # RL/GS
        sys.argv[1:] = ['custom_train', 'bin/config/gumbel_softmax.jsonnet', #'bin/config/gumbel_softmax_tmp.jsonnet', # {'bin/config/tmp_new.jsonnet', 'bin/config/spacy_retriever.jsonnet', 'bin/config/pretrain_retriever_tmp.jsonnet'},
