...
local transformer_weights_model = "bin/runs/ruletaker/2021-12-21_08-55-58_roberta-base";
local dataset_dir = "data/rule-reasoning-dataset-V2020.2.4/depth-5/";
local cuda_device = 4;
local adversarial_examples_path_train = "bin/runs/adversarial/2021-12-21_17-25-10_roberta-base/"; # "none","bin/runs/adversarial/2021-12-01_17-36-59-keep/train-records_epoch2.pkl"
local adversarial_examples_path_val = "bin/runs/adversarial/2021-12-21_17-25-10_roberta-base/"; # "none","bin/runs/adversarial/2021-12-01_17-36-59-keep/train-records_epoch2.pkl"
local adversarial_examples_path_test = "bin/runs/adversarial/2021-12-03_08-15-20-keep/val-records_epoch-1.pkl"; # "none","bin/runs/adversarial/2021-12-01_17-36-59-keep/train-records_epoch2.pkl"
