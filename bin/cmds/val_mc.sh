...
cuda_device=9
outdir_victim=bin/runs/ruletaker/2021-12-12_17-38-38_roberta-large
outdir_attacker=bin/runs/adversarial/2021-12-12_17-38-38_roberta-large
...
do
    ...
    raw_config=bin/config/attacker/test_config.jsonnet
    proc_config=bin/config/attacker/test_config_$dt.jsonnet
